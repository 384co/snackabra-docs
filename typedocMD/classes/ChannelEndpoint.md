...
- [#ChannelReadyFlag](ChannelEndpoint.md##channelreadyflag)
- [#SB384ReadyFlag](ChannelEndpoint.md##sb384readyflag)
- [#channelApi](ChannelEndpoint.md##channelapi)
- [#channelId](ChannelEndpoint.md##channelid)
- [#channelKeys](ChannelEndpoint.md##channelkeys)
- [#channelServer](ChannelEndpoint.md##channelserver)
- [#channelSignKey](ChannelEndpoint.md##channelsignkey)
- [#cursor](ChannelEndpoint.md##cursor)
...
- [#callApi](ChannelEndpoint.md##callapi)
- [#loadKeys](ChannelEndpoint.md##loadkeys)
- [#setKeys](ChannelEndpoint.md##setkeys)
